...
| 2 | Config, value types, persistence | BLOCKED (configuration correction only) | ao/k-2-8/root | bad9d61 | 13 pass, 0 fail; 21 assertions / 1 file; package typecheck unavailable |
| 3 | Foundations | TODO | | | |
